...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            //load_data();  
            pro_cnt = 0;
            $('.pd-setting-ed').click(function(event){
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table id="productTable">
                                    ...
                                    <?php
                                        $allProducts = new AdminManager();
                                        $pro = $allProducts->selectQuery("SELECT procomp.procomp_id AS 'pro', procomp.amount AS amount, procomp.cost AS cost, 'procomp' AS type, procomp.image AS image, procomp.pro_name AS pro_name, company.name as 'com_cl'
                                         FROM procomp
                                    ...
                                    ?>
                                    <tr id="<?php echo($pro[$i]['pro']);?>">
                                        <td><?php echo($pro[$i]['pro']);?></td>
                                        <td><img src="../<?php echo $pro[$i]['image'];?>" alt="" /></td>
                                        <td><?php echo($pro[$i]['pro_name']);?></td>
                                        <td>
                                            <?php
                                            if($pro[$i]['amount']>0){
                                            ?>
                                            ...
                                            ?>
                                            <button class="pd-setting">Non active</button>
                                        <?php }  ?>
                                        </td>
                                        <td><?php echo $pro[$i]['com_cl'];?></td>
                                        <td><?php echo $pro[$i]['amount'];?></td>
                                        <td><?php echo $pro[$i]['type'];?></td>
                                        <td><?php echo $pro[$i]['cost'].' $';?></td>
                                        <td>
                                            <button data-toggle="tooltip" title="Email" class="pd-setting-ed delete" id="<?php echo $pro[$i]['pro'];?>" name="<?php echo $pro[$i]['type'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                            <button data-toggle="tooltip" title="Delete" class="pd-setting-ed" id="<?php echo $pro[$i]['pro'];?>" name="<?php echo $pro[$i]['type'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                   <?php } } ?>                                    
                                </table>

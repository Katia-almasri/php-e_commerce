    ...
    <script src="js/vendor/modernizr-2.8.3.min.js"></script>
     ...
     <script type="text/javascript">
           $(document).ready(function(){
            ...
            $('.pd-setting-ed-email').click(function(event){
                event.preventDefault();
                alert($(this).attr('id'));
                //here put email code
            })
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <?php
                                        ...
                                        $allCompanies = $admin->selectQuery("SELECT * FROM company");
                                        if($allCompanies!==NULL){
                                            for($i=0; $i<sizeof($allCompanies); $i++){


                                    ?>
                                    <tr id="<?php echo $allCompanies[$i]['com_id'];?>">
                                        <td><?php echo $allCompanies[$i]['com_id'];?></td>
                                        <td><img src="../<?php echo $allCompanies[$i]['image'];?>" alt="" /></td>
                                        <td>
                                            <button class="ps-setting"><?php echo $allCompanies[$i]['name'];?></button>
                                        </td>
                                        <td><?php echo $allCompanies[$i]['branch'];?></td>
                                        <td><?php echo $allCompanies[$i]['owner'];?></td>
                                        <td><?php echo $allCompanies[$i]['email'];?></td>
                                        <td><?php echo $allCompanies[$i]['location'];?></td>
                                        <td>
                                            <button data-toggle="tooltip" title="Email" class="pd-setting-ed-email" id="<?php echo $allCompanies[$i]['com_id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                            <button data-toggle="tooltip" title="Delete" class="pd-setting-ed" id="<?php echo $allCompanies[$i]['com_id'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                    <?php  }
                                        }

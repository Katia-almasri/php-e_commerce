                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">Order type</th>
                                                <th data-field="email" data-editable="true">Cost with shipment</th>
                                                <th data-field="phone" data-editable="true">Shipment cost</th>
                                                <th data-field="complete">Shipment name</th>
                                                <th data-field="task" data-editable="true">Order date</th>
                                                <th data-field="date" data-editable="true">Recieved date</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $shipment = new AdminManager();
                                                $allOrders = $shipment->selectQuery("SELECT order_client.order_id AS order_id, 'client' AS type, order_client.cost_with_shipment AS cost_with_shipment, order_client.shipment_cost AS shipment_cost, shipment.shipment_name AS shipment_name, order_client.date_order AS date_order, order_client.date_of_recieve AS date_of_recieve
                                                    FROM order_client
                                                    INNER JOIN shipment ON shipment.shipment_id = order_client.shipment_id
                                                    UNION
                                                    SELECT order_comp.order_id AS order_id, 'company' AS type, order_comp.cost_with_shipment AS cost_with_shipment, order_comp.shipment_cost AS shipment_cost, shipment.shipment_name AS shipment_name, order_comp.date_order AS date_order, order_comp.date_of_recieve AS date_of_recieve
                                                    FROM order_comp
                                                    INNER JOIN shipment ON shipment.shipment_id = order_comp.shipment_id
                                                    ORDER BY date_of_recieve DESC
                                                    ");
                                                if($allOrders!==NULL){
                                                    for($i = 0; $i<sizeof($allOrders); $i++){
                                            ?>
                                            <tr id="<?php echo($allOrders[$i]['order_id']);?>">
                                                <td id="<?php echo($allOrders[$i]['order_id']);?>"></td>
                                                <td><?php echo($allOrders[$i]['order_id']);?></td>
                                                <td><?php echo($allOrders[$i]['type']);?></td>
                                                <td><?php echo($allOrders[$i]['cost_with_shipment']);?></td>
                                                <td><?php echo($allOrders[$i]['shipment_cost']);?></td>
                                                <td class="datatable-ct"><?php echo($allOrders[$i]['shipment_name']);?>
                                                </td>
                                                <td><?php echo($allOrders[$i]['date_order']);?></td>
                                                <td><?php echo($allOrders[$i]['date_of_recieve']);?></td>

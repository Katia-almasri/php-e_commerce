                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Custumers List" href="http://localhost/phpsandbox/E_commerce/DBHolder/Admin/departments.php"><span class="mini-sub-pro">Company List</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <?php
                                        ...
                                        $allClients = $admin->selectQuery("SELECT * FROM client");
                                        if($allClients!==NULL){
                                            for($i=0; $i<sizeof($allClients); $i++){


                                    ?>
                                    <tr id="<?php echo $allClients[$i]['client_id'];?>">
                                        <td><?php echo $allClients[$i]['client_id'];?></td>
                                        <td><img src="../<?php echo $allClients[$i]['image'];?>" alt="" /></td>
                                        <td>
                                            <button class="ps-setting"><?php echo $allClients[$i]['username'];?></button>
                                        </td>
                                        <td><?php echo $allClients[$i]['email'];?></td>
                                        <td><?php echo $allClients[$i]['level'];?></td>
                                        <td><?php echo $allClients[$i]['work'];?></td>
                                        <td><?php echo $allClients[$i]['location'];?></td>

                                        <td>
                                            <button data-toggle="tooltip" title="Email" class="pd-setting-ed-email" id="<?php echo $allClients[$i]['client_id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                            <button data-toggle="tooltip" title="Delete" class="pd-setting-ed" id="<?php echo $allClients[$i]['client_id'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                    <?php  }
                                        }
